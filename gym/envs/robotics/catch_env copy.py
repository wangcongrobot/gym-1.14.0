...
class CatchEnv(robot_env_m.RobotEnvM):
    """Superclass for all Fetch Catch environments.
    """
    ...
    def _get_obs(self):
        ...
        # get image from the simulation
        self.render('rgb_array', 84, 84)
        ...
        if self.add_high_res_output:
            ...
            img_top_high = img_high = self.render('rgb_array', 512, 512)
            img_high = img_high[::-1, :, :]
    ...
    def _render_callback(self):
        ...
        # get sete_id from catch.xml file
